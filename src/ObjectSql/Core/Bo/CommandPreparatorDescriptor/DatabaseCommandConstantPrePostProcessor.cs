...
{
	public class DatabaseCommandConstantPrePostProcessor: SingleParameterPrePostProcessor
	{
		public DatabaseCommandConstantPrePostProcessor(string parameterName,
