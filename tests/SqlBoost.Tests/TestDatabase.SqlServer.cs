...
namespace SqlBoost.Tests
{
	namespace SqlBoost.Tests.dbo
	{
		...
		public partial class Employees
		{
			...
			[Column("TitleOfCourtesy",TypeName="nvarchar")]
			...
			[Column("HomePhone",TypeName="nvarchar")]
			public string HomePhone {get; set;}

			[Column("Extension",TypeName="nvarchar")]
		...
		public partial class Invoices
		{
			...
			[Column("Salesperson",TypeName="nvarchar")]
			...
			[Column("ShipperName",TypeName="nvarchar")]
		...
		public partial class MultiTypeTable
		{
			...
			[Column("Bit",TypeName="bit")]
			public bool? Bit {get; set;}

			[Column("Binary",TypeName="binary")]
			public byte[] Binary {get; set;}

			[Column("Char",TypeName="char")]
			...
			[Column("DateTime2",TypeName="datetime2")]
			public DateTime? DateTime2 {get; set;}

			[Column("DateTimeOffcet",TypeName="datetimeoffset")]
			public DateTimeOffset? DateTimeOffcet {get; set;}

			[Column("Decimal",TypeName="decimal")]
			...
			[Column("Int",TypeName="int")]
			public int? Int {get; set;}

			[Column("Money",TypeName="money")]
			public decimal? Money {get; set;}

			[Column("NChar",TypeName="nchar")]
			public string NChar {get; set;}

			[Column("NText",TypeName="ntext")]
			public string NText {get; set;}

			[Column("Numeric",TypeName="numeric")]
			public decimal? Numeric {get; set;}

			[Column("NVarchar",TypeName="nvarchar")]
			public string NVarchar {get; set;}

			[Column("Real",TypeName="real")]
			public float? Real {get; set;}

			[Column("SmallDateTime",TypeName="smalldatetime")]
			public DateTime? SmallDateTime {get; set;}

			[Column("SmallInt",TypeName="smallint")]
			public short? SmallInt {get; set;}

			[Column("SmallMoney",TypeName="smallmoney")]
			public decimal? SmallMoney {get; set;}

			[Column("Text",TypeName="text")]
			public string Text {get; set;}

			[Column("TinyInt",TypeName="tinyint")]
			public byte? TinyInt {get; set;}

			[Column("Guid",TypeName="uniqueidentifier")]
			public Guid? Guid {get; set;}

			[Column("Varbinary",TypeName="varbinary")]
			public byte[] Varbinary {get; set;}

			[Column("Varchar",TypeName="varchar")]
